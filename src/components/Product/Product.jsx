...
const Product = ({currentUser, _id, onProductLike, available, desc, description, discount, price, name, pictures, likes}) => {
       ...
       <>
           ...
           <div className={s.product}>
               ...
               <div className={s.desc}>
                   <span className={discount !== 0 ? s.oldPrice : s.price}>{price}&nbsp;P</span>
                   {discount !== 0 && <span className={cn(s.price, 'card__price_type_discount')}>{discountPrice}&nbsp;Р</span>}
